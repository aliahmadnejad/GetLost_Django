 ...
 *
 * Copyright 2014-present Chen FengyuanP
...
! function (t, e) {
    ...
    var s = {
        ...
        template: '<div class="datepicker-container"><div class="datepicker-panel" data-view="years picker"><ul class="calender-header"><li data-view="years prev" class="list-item-left">&lsaquo;</li><li data-view="years current"></li><li data-view="years next" class="list-item-right">&rsaquo;</li></ul><ul class="data-view-years" data-view="years"></ul></div><div class="datepicker-panel" data-view="months picker"><ul class="calender-header"><li data-view="year prev" class="list-item-left">&lsaquo;</li><li data-view="year current"></li><li data-view="year next" class="list-item-right">&rsaquo;</li></ul><ul class="data-view-months" data-view="months"></ul></div><div class="datepicker-panel" data-view="days picker"><ul class="calender-header"><li class="list-item-left" data-view="month prev">&lsaquo;</li><li class="list-item-center" data-view="month current"></li><li class="list-item-right" data-view="month next">&rsaquo;</li></ul><ul data-view="week"></ul><ul class="data-view-days" data-view="days"></ul></div></div>',
        offset: 10,
        zIndex: 1e3,
        filter: null,
        show: null,
